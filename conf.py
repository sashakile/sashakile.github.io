...
BLOG_AUTHOR = "sasha kile"  # (translatable)
BLOG_TITLE = "In not like Sasha"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://sashakile.github.io/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://sashakile.github.io/"
BLOG_EMAIL = "saxa.kile@gmail.com"
BLOG_DESCRIPTION = "Un lugar para volcar las cosas que me intresan y pasan por mi cabeza"  # (translatable)
...
NAVIGATION_LINKS = {
    DEFAULT_LANG: (
        ("/home.html", "home"),
        ("/pages/cli/index.html", "cli"),
        ("/pages/alt-doc/index.html", "alt-doc"),
    ),
